# DFCI GPT clinical annotation pipelines

This wrapper contains the DFCI Azure OpenAI / GPT clinical-note annotation
pipelines and related note-preparation utilities. Run commands from this
`dfci_gpt/` directory.
